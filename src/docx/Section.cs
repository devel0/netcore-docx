...
public static partial class DocXExt
{
        ...
        HeaderFooterValues? type = null)
    {
        ...
        sectionProperties.InsertAt(new HeaderReference { Type = type ?? HeaderFooterValues.Default, Id = id }, 0);
        ...
        HeaderFooterValues? type = null)
    {
        ...
        sectionProperties.InsertAt(new FooterReference { Type = type ?? HeaderFooterValues.Default, Id = id }, 0);
