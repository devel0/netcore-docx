...
public static partial class DocXExt
{
    ...
    public static void AddBreak(this WordprocessingDocument doc, BreakValues? type = null) =>
        doc.GetLastElement()?.AddBreak(type ?? BreakValues.Page);
    ...
    public static Table AddTable(this WordprocessingDocument doc,
        ...
        TableRowAlignmentValues? align = null) => doc
        .GetLastParagraph(createIfNotExists: true)!
        .AddTable(tableWidthPercent, align ?? TableRowAlignmentValues.Left);
