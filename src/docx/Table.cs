...
public static partial class DocXExt
{
    ...
    /// set border
    /// </summary>
    /// <param name="borderType">(default:single)</param>
    public static BorderType SetType(this BorderType borderType,
        BorderValues? type = null)
    {
        borderType.Val = type ?? BorderValues.Single;
        ...
        TableRowAlignmentValues? align = null)
    {
...

        {
            ...
            var tableJustification1 = new TableJustification { Val = align ?? TableRowAlignmentValues.Left };
    ...
    public static TableCell SetShading(this TableCell tableCell,
        ...
        tableCell.SetShading<TableCell, TableCellProperties>(color, pattern ?? ShadingPatternValues.Clear);
