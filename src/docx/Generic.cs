...
public static partial class DocXExt
{
    ...
    /// <param name="type">type of break (default page)</param>
    ...
    public static Paragraph AddBreak<T>(this T element, BreakValues? type = null) where T : OpenXmlElement
    {
        ...
        if (element is Paragraph paragraph)
            return doc.AddParagraph("",
                ...
                action: run => run.Append(new Break { Type = type ?? BreakValues.Page }));
    ...
    /// set shading
    /// </summary>
    /// <param name="pattern">(default clear)</param>
        ...
        where T : OpenXmlElement
    {
        ...
        if (shading is null)
        {
            ...
            {
                shading = createShading(runProperties, color, pattern ?? ShadingPatternValues.Clear);
            }
        }
        else
        {
