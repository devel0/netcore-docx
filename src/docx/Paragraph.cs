...
public static partial class DocXExt
{
    ...
    /// <param name="underline">underline type (default: single)</param>
    /// <returns>run</returns>
    public static Run SetUnderline(this Run run, UnderlineValues? underline = null)
    {
        var runProperties = run.GetProperties(createIfNotExists: true)!;

        runProperties.Underline = new Underline { Val = underline ?? UnderlineValues.Single };
    ...
    /// <param name="pattern">shading pattern type (default: clear)</param>
    /// <returns>paragraph</returns>
    public static Paragraph SetShading(this Paragraph paragraph,
        System.Drawing.Color? color = null,
        ShadingPatternValues? pattern = null) =>
        paragraph.SetShading<Paragraph, ParagraphProperties>(color, pattern ?? ShadingPatternValues.Clear);
    ...
    public static Run SetShading(this Run run, System.Drawing.Color? color = null,
        ShadingPatternValues? pattern = null) =>
        run.SetShading<Run, RunProperties>(color, pattern ?? ShadingPatternValues.Clear);
    ...
    /// <param name="format">type of numbering (default: bullet)</param>        
        ...
        bool restartNumbering = false)
    {
        ...
        var abstractNum = doc.GetAbstractNum(format ?? NumberFormatValues.Bullet, structured, restartNumbering);
    ...
    /// </summary>
    /// <param name="paragraph">paragraph</param>
    /// <param name="type">underline type (default: single)</param>
    /// <returns>paragraph</returns>
    public static Paragraph SetUnderline(this Paragraph paragraph, 
        UnderlineValues? type = null) =>
        paragraph.Act(paragraph => paragraph.GetRuns().Foreach(run => run.SetUnderline(type ?? UnderlineValues.Single)));
